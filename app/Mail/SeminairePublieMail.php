...
use App\Models\User; // L'utilisateur destinataire
...
class SeminairePublieMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Nouveau Séminaire Programmé : ' . $this->seminaire->titre,
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.seminaires.publication',
            with: [
                ...
                'resumeCourt' => Str::limit($this->seminaire->resume, 150), // Un extrait du résumé
                'urlDetailsSeminaire' => route('seminaires.authentifie.show', $this->seminaire->id), // Ou public.show si accessible
            ],
        );
    }
